...
description: |
  La Teoría de Átomos en Moléculas (AIM) es una metodología desarrollada por Richard F. W. Bader en las décadas de 1970 y 1980. AIM proporciona una manera rigurosa y matemática de definir átomos dentro de una molécula a través del análisis topológico de la densidad electrónica. Al identificar puntos críticos y superficies de cero flujo en la densidad electrónica, AIM permite delinear regiones atómicas y estudiar las interacciones entre ellas. Esta teoría ha tenido un impacto significativo en la química teórica y computacional, facilitando la comprensión de la estructura electrónica, la reactividad química y el diseño de materiales.
author:
...
Esta ecuación muestra la densidad electrónica, donde \(\psi_i(\mathbf{r})\) son las funciones de onda de los electrones.
...
La ecuación para identificar un punto crítico en la densidad electrónica es:
...
Los puntos críticos de enlace (BCP) son esenciales para caracterizar y entender enlaces covalentes, iónicos y no covalentes. La densidad electrónica en estos puntos y su curvatura proporcionan información crucial sobre la fuerza y naturaleza del enlace.
...
La ecuación para la densidad en un punto crítico de enlace es:
