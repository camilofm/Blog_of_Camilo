...
Basándose en la topología de la densidad electrónica, la teoría AIM proporciona una manera precisa de identificar y definir los átomos y sus interacciones dentro de una molécula. Esta teoría permite el análisis detallado de la estructura molecular a través de los puntos críticos de la densidad electrónica.
...
\[
\left. \nabla \rho(\mathbf{r}) \right|_{\text{Superficie}} = 0
\]
